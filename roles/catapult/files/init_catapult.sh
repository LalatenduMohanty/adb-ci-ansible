...
${OC_BINARY} env dc/${APP_NAME} OPENSHIFT_SMTP_HOST=localhost KONTINUITY_CATAPULT_GITHUB_APP_CLIENT_ID=${KONTINUITY_CATAPULT_GITHUB_APP_CLIENT_ID} KONTINUITY_CATAPULT_GITHUB_APP_CLIENT_SECRET=${KONTINUITY_CATAPULT_GITHUB_APP_CLIENT_SECRET} CATAPULT_OPENSHIFT_API_URL=https://openshift.default.svc.cluster.local CATAPULT_OPENSHIFT_CONSOLE_URL=https://10.1.2.2:8443
